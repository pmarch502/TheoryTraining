// Usage: Load in index.html; data-term=\"slug\".
window.glossary = {
  'augmented-fifth': {
  ...
  'harmony': {
    title: 'Harmony',
    def: 'The simultaneous combination of tones, particularly the use of chords and their progression, to create a structured and pleasing vertical aspect of music. It contrasts with melody (horizontal succession of notes) and rhythm (temporal organization).',
    category: 'other'
  },
  'interval': {
    title: 'Interval',
  ...
  'scale': {
    title: 'Scale',
    def: 'An ordered sequence of notes, typically spanning an octave, arranged in ascending or descending order according to a specific pattern of intervals (whole steps and half steps, or tones and semitones). It serves as the foundational pitch collection for melodies, harmonies, and improvisation within a musical composition or tradition.',
    category: 'scale-key'
  },
  'sharp': {
    title: 'Sharp',
